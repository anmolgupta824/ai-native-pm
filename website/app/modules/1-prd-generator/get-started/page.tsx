              ...
              <div className="border-l-4 border-brand-500 pl-6">
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-xl p-5 mb-4">
                  ...
                  <div className="bg-gray-100 rounded-lg p-4 font-mono text-sm text-gray-700">
                    ...
                    cd ai-native-pm/modules/module-1-prd/teacher-mode/mcp-server<br />
                    npm install<br />
                    npm run build
                  </div>
                </div>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-xl p-5">
                  ...
                  <ol className="text-sm text-gray-600 space-y-1 list-decimal list-inside">
                    ...
                    <li>Unzip and navigate to <code className="bg-gray-200 px-1 rounded text-xs">modules/module-1-prd/teacher-mode/mcp-server</code></li>
