...
**Subtitle:** After two years of testing every AI tool in my LinkedIn feed, here's what actually stuck -- and what I stopped using.

**Header Image:** Use `marketing/assets/launch-image.png`

**Tags:** Product Management, Artificial Intelligence, Productivity, Claude Code

---

I'm Anmol. I run payments at Careem (Uber for the Middle East). 50M customers. $120M/month. And I use AI differently than most PMs I know. This is where I share how.
...
If this was useful, subscribe. I publish weekly -- one practical AI workflow for PMs at a time.

---

*Anmol Gupta is a Product Manager at Careem (Uber), leading Payments & Fintech. Previously at Visa and RAENA. MBA from Nanyang Business School, B.Tech CS from NIT Warangal. Based in Dubai, UAE. He writes about practical AI workflows for product managers at [The AI-Native PM](https://theainativepm.com).*
