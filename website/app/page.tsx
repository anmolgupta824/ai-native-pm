...
const modules = [
  ...
  },
  {
    ...
    description:
      'Master MCP integrations in one weekend. Connect Claude to Jira, Google Drive, Sheets, and Figma — zero prior knowledge required.',
    price: 'Free',
    tag: 'Build Skills',
    features: [
      '7 interactive lessons',
      'Teacher Mode with exercises & quizzes',
      'Jira, Google Drive, Sheets, Figma',
