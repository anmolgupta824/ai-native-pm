# Lesson 3: PRD Structure & Templates

**Estimated time: 20 minutes**
**Lesson type: Framework + Comparison**

---

## Anatomy of a Well-Structured PRD
...
## Pro Tips for Better PRD Structure
...
## Exercise: Analyze a PRD Template

Deep-dive into the template that best fits your project and identify which sections you'd customize.

1. Use `list_templates` to see all three templates
2. Pick the one that best fits your current project
3. Use `get_questions` to see the 10 questions for your chosen template
4. For each question, write a 1-sentence answer (even if rough)
5. Identify which sections of the template you'd add, remove, or rename for your team's format
6. Ask Claude: "What's missing from this template for a [your industry] product?"

**Completion check:** You've completed this exercise if: (1) You've reviewed all three templates, (2) You have rough answers for all 10 questions in your chosen template, and (3) You've identified at least one customization for your team's needs.

---

## Quick Check

1. What are the three sections PMs most commonly skip in PRDs?
2. When should you use the API Integration template instead of Feature Launch?
3. What two unique sections does the Product Redesign template include?
4. What makes a success metric "falsifiable"?

---

*Previous: [Lesson 2: Context & Socratic Questioning](2-context-questioning.md)*
*Next: [Lesson 4: Generating & Validating PRDs](4-generating-validating.md)*
