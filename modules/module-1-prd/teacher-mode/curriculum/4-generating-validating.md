# Lesson 4: Generating & Validating PRDs

**Estimated time: 25 minutes**
**Lesson type: Hands-on + Practice**
...
## The Generate-Validate-Improve Loop
...
## Exercise: Generate and Validate a PRD

Generate a complete PRD from your answers and iterate on it using the validation loop.

1. Use `generate_prd` with your template type, product name, and your question answers from previous exercises
2. Read through the generated PRD -- does it capture your thinking accurately?
3. Use `validate_prd` on the generated PRD and note the score and missing sections
4. Address the top 3 gaps identified by validation (add metrics, edge cases, or risks)
5. Use `suggest_edge_cases` to get edge case ideas and add the 5 most relevant ones
6. Re-validate the improved PRD -- aim for a B grade (80%) or higher
7. If you're below B, iterate one more time on the remaining gaps

**Completion check:** You've completed this exercise if: (1) You generated a complete PRD, (2) You validated it and saw specific gaps, (3) You improved it and re-validated with a higher score, and (4) Your PRD scores at least 80% (Grade B).

---

## Quick Check

1. What does a Grade C (60-79%) validation score mean?
2. What is the most common gap found by validate_prd?
3. How should you format edge cases in your PRD?
4. When should you stop iterating on a PRD?

---

*Previous: [Lesson 3: PRD Structure & Templates](3-prd-structure.md)*
*Next: [Lesson 5: Multi-Perspective Review](5-multi-perspective-review.md)*
