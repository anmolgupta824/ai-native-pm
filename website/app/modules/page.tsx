...
const modules = [
  ...
  },
  {
    ...
    description:
      'Generate product mockups, presentation visuals, and social media assets in minutes using DALL-E. No design skills required.',
    price: 'Free',
    tag: 'Visual Assets',
    features: [
      '6 DALL-E image generation tools',
      'Product mockups & wireframe generation',
      'Presentation & pitch deck visuals',
      'Social media asset packs (4 coordinated images)',
      'Prompt engineering course (6 lessons)',
      'Reusable prompt templates included',
    ],
    href: '/modules/2-image-gen',
    timeline: 'Available now',
    promise: 'Generate your first product mockup in 5 minutes',
  },
  {
    number: 3,
    title: 'MCP Integrations Course',
    description:
      'Master MCP integrations in one weekend. Learn to connect Claude to Jira, Google Drive, Sheets, and Figma — zero prior knowledge required.',
    price: 'Free',
    tag: 'Build Skills',
    features: [
      '7 interactive lessons — zero to MCP expert',
      'Teacher Mode with exercises and quizzes',
      'Build Jira, Google Drive, Sheets integrations',
      'Google Drive, Sheets, Jira, Figma templates',
